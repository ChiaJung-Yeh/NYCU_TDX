...
Take retrieving MRT stations of Taipei Metro System for example. The code and its result are shown below. Note that the parameter `app_id` and `app_key` is the authentication key applied from PTX.  

```{r TDX_test_show, echo=T, eval=T}
